...
import 'package:flutter_sqflite_crud/repository/database_creator.dart';
import 'package:flutter_sqflite_crud/repository/repository_service_todo.dart';
...
class _SqfLiteCrudState extends State<SqfLiteCrud> {
  ...
  void readData() async {
    ...
    print(todo.name);
    _showDialog(todo.name);
  }
  void readDataByName(String name) async {
    final todo = await RepositoryServiceTodo.getTodoByName(name);
    print(todo.name);
    _showDialog(todo.name);
  }
  ...
  void getTodo()async{
    await RepositoryServiceTodo.getTodoByName(name);
        ...
        children: <Widget>[
          ...
          Row(
            ...
            children: <Widget>[
              ...
              RaisedButton(
                onPressed: id != null ? getTodo : null,
